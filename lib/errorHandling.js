...
/**
 * Loan instance assertion to check if an instance was returned.
 * @param {object} [loan] - a loan instance
 * @param {number} loan.id - the id of the loan
 * @param {object} loan.returned_on - the date the loan was returned
 * @throws {object} - an error if `returned_on` is not null.
 *
*/
 ...
 *
*/
async function assertValidationError(req, res, error, {errorView=null, model=null, addToBuild=()=>({})}={}) {
